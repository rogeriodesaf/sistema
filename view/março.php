...
function adicionarDado(idprocesso) { //ver linha 9 de obterDadosProcessos.
    ...
    $.ajax({
        ...
        data: "idprocesso=" +
            idprocesso, // esse idprocesso está referenciando o id que está em obterDadosProcessos.php na linha 9. O CAMPO idprocesso É PASSADO TODA VEZ QUE EU CLICAR NO BOTÃO QUE
        ...
        success: function(r) { //FUNÇÃO QUE FAZ UMA CONSULTA NOS DADOS
            ...
            dado = jQuery.parseJSON(
                r
            ); //OS DADOS QUE ESTÃO NOS CAMPOS 'id_fornecedor','nrofa',etc... ESTÃO SENDO PASSADOS VIA JSON
...
$(document).ready(function() { //ao ler o documento ...
    ...
    $('#btnAdicionarProcessos').click(function() { //ao clicar no botão da linha 56 ele vai...
        ...
        vazios = validarFormVazio(
            'frmProcessos'); //verificar se existem campos vazios no formulário da linha 19...
        ...
        dados = $('#frmProcessos')
            .serialize(); // aqui vamos pegar os dados recebidos do formulário da linha 19 e serializar via JSON  e passadas para a url da linha 182
        ...
        $.ajax({
            ...
            success: function(r) {
                ...
                if (r ==
                    1
                ) { // ver classes/processos a função adicionar. Ela gera por padrão o valor de 1.
                    $('#frmProcessos')[0]
                        .reset(); // após adicionar vai dar um reset nos campos limpando eles dentro do formulário.
