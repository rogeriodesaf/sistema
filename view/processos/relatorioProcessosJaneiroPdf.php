...
while ($array11 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql14 = "SELECT  relator, COUNT(relator) as Qtd from fornecedores where relator='Fábio' and MONTH(data) = '1'and year(data) = '2020'";
...
while ($array14 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql16 = "SELECT sum(valor_2) as valor_2 from fornecedores where relator='Fábio' and MONTH(data) = '1'and year(data) = '2020'";
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            ...
            <?php
$sql21 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where  MONTH(data) = '1' and year(data) = '2020'";
