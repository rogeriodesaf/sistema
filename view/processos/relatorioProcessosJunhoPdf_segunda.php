...
$c = new conectar();
$conexao = $c->conexao();
$sql = "SELECT id_fornecedor2, nrofa2, consumidor2, fornecedor2,  relator2, valor2, valor_seg,data2, ano2, recurso2 FROM fornecedores2 WHERE MONTH(data2) = '6' and year(data2) = '2020'";
...
$total2Grau = "SELECT sum(valor2) as valor2 from fornecedores2 where  MONTH(data2) = '6' and year(data2) = '2020'"; //SELECT sum(valor2) as valor2 from fornecedores2 where camara2='1'"
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            <?php
$total2Grau = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where  MONTH(data2) = '6' and year(data2) = '2020'";
$buscarDb = mysqli_query($conexao, $total2Grau);
$valor2 = 0;
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        ...
        <td>
            <?php
$sql6 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Kaio' and MONTH(data2) = '6' and year(data2) = '2020'";
...
while ($array4 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Kaio' and MONTH(data2) = '6' and year(data2) = '2020'";
...
while ($array3 = mysqli_fetch_array($buscarrelator2)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql7 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Emannuel' and MONTH(data2) = '6' and year(data2) = '2020'";
...
while ($array5 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Emannuel' and MONTH(data2) = '6' and year(data2) = '2020'";
$buscarrelator2 = mysqli_query($conexao, $sql5);
$valor2 = 0;
...
while ($array3 = mysqli_fetch_array($buscarrelator2)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql9 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Juliana' and MONTH(data2) = '6' and year(data2) = '2020'";
...
while ($array9 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Juliana' and MONTH(data2) = '6' and year(data2) = '2020'";
$buscarrelator2 = mysqli_query($conexao, $sql5);
$valor2 = 0;
...
while ($array3 = mysqli_fetch_array($buscarrelator2)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql9 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Sérgio' and MONTH(data2) = '6' and year(data2) = '2020'";
$buscar = mysqli_query($conexao, $sql9);
$Qtd = 0;
...
while ($array9 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Sérgio' and MONTH(data2) = '6' and year(data2) = '2020'";
$buscarrelator2 = mysqli_query($conexao, $sql5);
$valor2 = 0;
...
while ($array3 = mysqli_fetch_array($buscarrelator2)) {
    ...
    <td>
        <?php
$sql10 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Fernando' and MONTH(data2) = '6' and year(data2) = '2020'";
...
while ($array10 = mysqli_fetch_array($buscar)) {
    ...
    <td>
        ...
        <?php
$sql11 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Fernando' and MONTH(data2) = '6' and year(data2) = '2020'";
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            ...
            <?php
$sql21 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where  MONTH(data2) = '6' and year(data2) = '2020'";
