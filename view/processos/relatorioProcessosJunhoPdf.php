...
$total3Grau = "SELECT sum(valor) as valor from fornecedores where  MONTH(data) = '6' and year(data) = '2020'"; //SELECT sum(valor) as valor from fornecedores where camara='1'"
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            <?php
$total3Grau = "SELECT sum(valor_2) as valor_2 from fornecedores where  MONTH(data) = '6' and year(data) = '2020'";
$buscarDb = mysqli_query($conexao, $total3Grau);
$valor = 0;
