...
<tr>
	<td>
		<?php
			...
			$total2Grau = "SELECT sum(valor) as valor from fornecedores where camara='1' and MONTH(data) = '3'";   //SELECT sum(valor) as valor from fornecedores where camara='1'"
...
<tr>
	<td>
		<?php
			$total2Grau = "SELECT sum(valor) as valor from fornecedores where camara='2' and MONTH(data) = '3'";
			$buscarDb = mysqli_query($conexao, $total2Grau);
			$valor=0;
