...
$sql2 = "SELECT * FROM fornecedores2 WHERE MONTH(data2) = '4' and year(data2) = '2020'";
...
while ($array2 = mysqli_fetch_array($buscarrelator2)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql9 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Filipe' and MONTH(data2)= '4' and Year(data2) ='2020' ";
...
while ($array2 = mysqli_fetch_array($buscarrelator2)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql10 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Cyro' and MONTH(data2) = '4' and Year(data2) ='2020' ";
...
while ($array10 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            ...
            <?php
$sql11 = "SELECT sum(valor2) as valor2 from fornecedores2 where relator2='Filipe' and MONTH(data2) = '4' and Year(data2) ='2020' ";
