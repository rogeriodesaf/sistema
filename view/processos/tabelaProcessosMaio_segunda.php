...
$sql2 = "SELECT * FROM fornecedores2 WHERE MONTH(data2) = '5' and year(data2) = '2020'";
...
<td style="align:center;">
    <a href="../procedimentos/pdf/criarRelatorioMaio_segundaPdf.php?idprocesso=<" class="btn btn-danger btn-sm">
...
<table style="text-align: center;
    ...
    <tr>
        <td style=" text-decoration:none color:#FFF;"><a href="relatores_maio_segunda.php">Total
                <!--target="_blank" -->
                de
