...
$total2Grau = "SELECT sum(valor) as valor from fornecedores where  MONTH(data) = '8' and Year(data) = '2020'"; //SELECT sum(valor) as valor from fornecedores where camara='1'"
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            <?php
$total2Grau = "SELECT sum(valor_2) as valor_2 from fornecedores where  MONTH(data) = '8' and Year(data) = '2020'";
$buscarDb = mysqli_query($conexao, $total2Grau);
$valor = 0;
...
$sql2 = "SELECT sum(valor + valor_2) as soma FROM fornecedores WHERE MONTH(data) = '8' and Year(data) = '2020'";
