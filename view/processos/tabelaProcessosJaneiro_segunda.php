...
$total2Grau = "SELECT sum(valor2) as valor2 from fornecedores2 where  MONTH(data2) = '1' and Year(data2) = '2020'"; //SELECT sum(valor) as valor from fornecedores where camara='1'"
...
$sql2 = "SELECT SUM(valor2 + valor_seg ) as soma FROM fornecedores WHERE MONTH(data2) = '1' and Year(data2) = '2020'";
