...
$total2Grau = "SELECT sum(valor2) as valor_seg from fornecedores2 where  MONTH(data2) = '1' and Year(data2) = '2020'"; //SELECT sum(valor) as valor from fornecedores where camara='1'"
...
$total2Grau = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where  MONTH(data2) = '1 ' and Year(data2) = '2020'";
$buscarDb = mysqli_query($conexao, $total2Grau);
$valor = 0;
...
$sql2 = "SELECT SUM(valor2 + valor_seg ) as soma FROM fornecedores2 WHERE MONTH(data2) = '1' and Year(data2) = '2020'";
