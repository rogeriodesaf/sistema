...
$total3Grau = "SELECT sum(valor2) as valor2 from fornecedores2 where  MONTH(data2) = '2' and year(data2) = '2020'"; //SELECT sum(valor) as valor from fornecedores where camara='1'"
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            <?php
$total3Grau = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where  MONTH(data2) = '2' and year(data2) = '2020'";
$buscarDb = mysqli_query($conexao, $total3Grau);
$valor = 0;
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        ...
        <td>
            <?php
$sql6 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Kaio' and MONTH(data2) = '2'and year(data2) = '2020'";
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql9 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Emannuel' and MONTH(data2) = '2'and year(data2) = '2020'";
...
while ($array9 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Emannuel' and MONTH(data2) = '2'and year(data2) = '2020'";
$buscarrelator = mysqli_query($conexao, $sql5);
$valor = 0;
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql10 = "SELECT  relator2, COUNT(relator2) as Qtd from fornecedores2 where relator2='Juliana' and MONTH(data2) = '2'and year(data2) = '2020'";
...
while ($array10 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            ...
            <?php
$sql11 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Juliana' and MONTH(data2) = '2'and year(data2) = '2020'";
...
while ($array11 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql14 = "SELECT  relator2, COUNT(relator2) as Qtd from fornecedores2 where relator2='Sérgio' and MONTH(data2) = '2'and year(data2) = '2020'";
...
while ($array14 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql16 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Sérgio' and MONTH(data2) = '2'and year(data2) = '2020'";
...
while ($array13 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql14 = "SELECT  relator2, COUNT(relator2) as Qtd from fornecedores2 where relator2='Fernando' and MONTH(data2) = '2'and year(data2) = '2020'";
$buscar = mysqli_query($conexao, $sql14);
$Qtd = 0;
...
while ($array14 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql16 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Fernando' and MONTH(data2) = '2'and year(data2) = '2020'";
$buscarrelator = mysqli_query($conexao, $sql16);
$valor = 0;
