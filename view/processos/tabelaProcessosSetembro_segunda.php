...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            <?php
$total2Grau = "SELECT sum(valor2) as valor2 from fornecedores2 where  MONTH(data2) = '9' and year(data2) = '2020'";
$buscarDb = mysqli_query($conexao, $total2Grau);
$valor2 = 0.00;
...
$sql2 = "SELECT * FROM fornecedores2 WHERE MONTH(data2) = '9' and year(data2) = '2020'";
...
<td style="align:center;">
    <a href="../procedimentos/pdf/criarRelatorioSetembro_segundaPdf.php?idprocesso=<" class="btn btn-danger btn-sm">
...
<table style="text-align: center;
    ...
    <tr>
        <td style=" text-decoration:none color:#FFF;"><a href="relatores_setembro_segunda.php">Total
                <!--target="_blank" -->
                de
