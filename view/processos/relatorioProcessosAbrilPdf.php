...
$sql3 = "SELECT sum(valor+valor_2) as soma   FROM fornecedores WHERE MONTH(data) = '4' and year(data) = '2020'";
...
$sql3 = "SELECT sum(valor+valor_2) as soma FROM fornecedores WHERE YEAR(data) = '2020' ";
$buscar3 = mysqli_query($conexao, $sql3);
$valor = 0;
while ($array3 = mysqli_fetch_array($buscar3)) {
...
while ($array11 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql14 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Fábio' and MONTH(data) = '4'";
...
while ($array14 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql16 = "SELECT sum(valor) as valor from fornecedores where relator='Fábio' and MONTH(data) = '4'";
