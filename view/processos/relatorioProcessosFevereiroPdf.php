...
$total3Grau = "SELECT sum(valor) as valor from fornecedores where  MONTH(data) = '1' and year(data) = '2020'"; //SELECT sum(valor) as valor from fornecedores where camara='1'"
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            <?php
$total3Grau = "SELECT sum(valor_2) as valor_2 from fornecedores where  MONTH(data) = '1' and year(data) = '2020'";
$buscarDb = mysqli_query($conexao, $total3Grau);
$valor = 0;
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        ...
        <td>
            <?php
$sql6 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Demetrius' and MONTH(data) = '2'and year(data) = '2020'";
...
while ($array4 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor_2) as valor_2 from fornecedores where relator='Demetrius' and MONTH(data) = '2'and year(data) = '2020'";
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql9 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Filipe' and MONTH(data) = '2'and year(data) = '2020'";
...
while ($array9 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor_2) as valor_2 from fornecedores where relator='Filipe' and MONTH(data) = '2'and year(data) = '2020'";
$buscarrelator = mysqli_query($conexao, $sql5);
$valor = 0;
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql10 = "SELECT  relator, COUNT(relator) as Qtd from fornecedores where relator='Cyro' and MONTH(data) = '2'and year(data) = '2020'";
...
while ($array10 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            ...
            <?php
$sql11 = "SELECT sum(valor_2) as valor_2 from fornecedores where relator='Cyro' and MONTH(data) = '2'and year(data) = '2020'";
...
while ($array11 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql14 = "SELECT  relator, COUNT(relator) as Qtd from fornecedores where relator='Fábio' and MONTH(data) = '2'and year(data) = '2020'";
...
while ($array14 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql16 = "SELECT sum(valor_2) as valor_2 from fornecedores where relator='Fábio' and MONTH(data) = '2'and year(data) = '2020'";
...
while ($array13 = mysqli_fetch_array($buscarrelator)) {
    ...
    <td>
        <?php
$sql12 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Kaio(Suplente)' and MONTH(data) = '2'and year(data)='2020'";
$Qtd = 0;
...
while ($array12 = mysqli_fetch_array($buscar)) {
    ...
    <td>
        <?php
$sql11 = "SELECT sum(valor_2) as valor_2 from fornecedores where relator='Kaio(Suplente)' and MONTH(data) = '2'and year(data)='2020'";
$buscarrelator = mysqli_query($conexao, $sql11);
$valor = 0;
...
while ($array12 = mysqli_fetch_array($buscar)) {
    ...
    <td>
        <?php
$sql11 = "SELECT sum(valor_2) as valor_2 from fornecedores where relator='Emannuel(Suplente)' and MONTH(data) = '2'and year(data)='2020'";
$buscarrelator = mysqli_query($conexao, $sql11);
$valor = 0;
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            ...
            <?php
$sql21 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where  MONTH(data) = '2' and year(data) = '2020'";
