...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        ...
        <td>
            <?php
$sql6 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Demetrius' and MONTH(data) = '7'";
...
while ($array4 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor) as valor from fornecedores where relator='Demetrius' and MONTH(data) = '7'";
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql7 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Edson' and MONTH(data) = '7'";
...
while ($array5 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor) as valor from fornecedores where relator='Edson' and MONTH(data) = '7'";
$buscarrelator = mysqli_query($conexao, $sql5);
$valor = 0;
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql9 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Filipe' and MONTH(data) = '7'";
...
while ($array9 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql5 = "SELECT sum(valor) as valor from fornecedores where relator='Filipe' and MONTH(data) = '7'";
$buscarrelator = mysqli_query($conexao, $sql5);
$valor = 0;
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql21 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Emannuel' and MONTH(data) = '7'";
...
while ($array21 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql18 = "SELECT sum(valor) as valor from fornecedores where relator='Emannuel' and MONTH(data) = '7'";
...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql10 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Cyro' and MONTH(data) = '7'";
...
while ($array10 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            ...
            <?php
$sql11 = "SELECT sum(valor) as valor from fornecedores where relator='Filipe' and MONTH(data) = '7'";
...
while ($array11 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql12 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Juliana' and MONTH(data) = '7'";
...
while ($array12 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql11 = "SELECT sum(valor) as valor from fornecedores where relator='Juliana' and MONTH(data) = '7'";
$buscarrelator = mysqli_query($conexao, $sql11);
$valor = 0;
...
while ($array13 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql14 = "SELECT relator, COUNT(relator) AS Qtd FROM fornecedores where relator='Sérgio' and MONTH(data) = '7'";
...
while ($array14 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql16 = "SELECT sum(valor) as valor from fornecedores where relator='Sérgio' and MONTH(data) = '7'";
