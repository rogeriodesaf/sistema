...
while ($array3 = mysqli_fetch_array($buscarrelator)) {
    ...
    <td>
        <?php
$sql21 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Emannuel' and MONTH(data2) = '8' and year(data2) = '2020'";
...
while ($array21 = mysqli_fetch_array($buscar)) {
    ...
    <td>
        <?php
$sql18 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Emannuel' and MONTH(data2) = '8' and year(data2) = '2020'";
...
while ($array11 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql12 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Juliana' and MONTH(data2) = '8' and year(data2) = '2020'";
$Qtd = 0;
...
while ($array12 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql11 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Juliana' and MONTH(data2) = '8' and year(data2) = '2020'";
$buscarrelator = mysqli_query($conexao, $sql11);
$valor = 0;
...
while ($array13 = mysqli_fetch_array($buscarrelator)) {
    ...
    <tr>
        ...
        <td>
            <?php
$sql14 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Sérgio'and MONTH(data2) = '8' and year(data2) = '2020'";
...
while ($array14 = mysqli_fetch_array($buscar)) {
    ...
    ?>
        ...
        <td>
            <?php
$sql16 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Sérgio'and MONTH(data2) = '8' and year(data2) = '2020'";
...
while ($array13 = mysqli_fetch_array($buscarrelator)) {
    ...
    <td>
        <?php
$sql21 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where relator2='Fernando' and MONTH(data2) = '8' and year(data2) = '2020'";
$buscar = mysqli_query($conexao, $sql21);
$Qtd = 0;
...
while ($array21 = mysqli_fetch_array($buscar)) {
    ...
    <td>
        <?php
$sql18 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Fernando' and MONTH(data2) = '8' and year(data2) = '2020'";
$buscarrelator = mysqli_query($conexao, $sql18);
$valor = 0;
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    <caption><label>Total de Processos no mês de Agosto.</label></caption>
    <tr>
        <td>
...
<td style="align:higth;">
    <a href="agosto_segunda.php" class="btn btn-danger btn-sm">
