...
while ($array21 = mysqli_fetch_array($buscar)) {
    ...
    <td>
        <?php
$sql18 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Emannuel' and MONTH(data2) = '4' and year(data2) = '2020'";
...
while ($array21 = mysqli_fetch_array($buscar)) {
    ...
    <td>
        <?php
$sql18 = "SELECT sum(valor_seg) as valor_seg from fornecedores2 where relator2='Fernando' and MONTH(data2) = '4' and year(data2) = '2020'";
$buscarrelator = mysqli_query($conexao, $sql18);
$valor = 0;
...
<table class="table table-hover table-condensed table-bordered" style="text-align: center;">
    ...
    <tr>
        <td>
            ...
            <?php
$sql21 = "SELECT relator2, COUNT(relator2) AS Qtd FROM fornecedores2 where  MONTH(data2) = '4' and year(data2) = '2020'";
$buscar = mysqli_query($conexao, $sql21);
$Qtd = 0;
