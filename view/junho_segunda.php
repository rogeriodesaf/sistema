            ...
            success: function(r) {
                ...
                if (r == 1) {
                    $('#tabelaProcessosLoad').load(
                        "processos/tabelaProcessosMaio_segunda.php");
...
$(document).ready(function() {
    ...
    $('#tabelaProcessosLoad').load("processos/tabelaProcessosJunho_segunda.php");
        ...
        $.ajax({
            ...
            success: function(r) {
                ...
                if (r == 1) {
                    ...
                    $('#tabelaProcessosLoad').load(
                        "processos/tabelaProcessosJunho_segunda.php"
