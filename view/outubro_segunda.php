        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmProcessosU">
                    ...
                    <label>nroFA</label>
                    <input type="text" class="form-control input-sm" id="nrofa2U" name="nrofa2U">
                    <label>Consumidor</label>
            ...
            success: function(r) {
                ...
                if (r == 1) {
                    $('#tabelaProcessosLoad').load(
                        "processos/tabelaProcessosOutubro_segunda.php");
...
$(document).ready(function() {
    ...
    $('#tabelaProcessosLoad').load("processos/tabelaProcessosOutubro_segunda.php");
